...
{for(var i = 0, len = gdjs.evtsExt__Smoothy__CreateLevel.GDSpawnerObjects3.length ;i < len;++i) {
    gdjs.evtsExt__Smoothy__CreateLevel.GDSpawnerObjects3[i].getBehavior(eventsFunctionContext.getBehaviorName("SpeedPathMovement")).DrawDebug(gdjs.evtsExt__Smoothy__CreateLevel.mapOfGDgdjs_9546evtsExt_9595_9595Smoothy_9595_9595CreateLevel_9546GDGutterPainterObjects3Objects, eventsFunctionContext);
}
}{gdjs.evtTools.object.createObjectOnScene(eventsFunctionContext, gdjs.evtsExt__Smoothy__CreateLevel.mapOfGDgdjs_9546evtsExt_9595_9595Smoothy_9595_9595CreateLevel_9546GDHoleObjects3Objects, gdjs.evtTools.variable.getVariableNumber(runtimeScene.getGame().getVariables().get("Levels").getChild((Number(eventsFunctionContext.getArgument("Level")) || 0)).getChild("Gutters").getChild(gdjs.evtTools.variable.getVariableString(runtimeScene.getScene().getVariables().get("index"))).getChild("StartX")) + gdjs.evtsExt__CurvedMovement__PathEndX.func(runtimeScene, (( gdjs.evtsExt__Smoothy__CreateLevel.GDGutterObjects3.length === 0 ) ? "" :gdjs.evtsExt__Smoothy__CreateLevel.GDGutterObjects3[0].getBehavior(eventsFunctionContext.getBehaviorName("GutterBehavior")).PathName(eventsFunctionContext)), eventsFunctionContext), gdjs.evtTools.variable.getVariableNumber(runtimeScene.getGame().getVariables().get("Levels").getChild((Number(eventsFunctionContext.getArgument("Level")) || 0)).getChild("Gutters").getChild(gdjs.evtTools.variable.getVariableString(runtimeScene.getScene().getVariables().get("index"))).getChild("StartY")) + gdjs.evtsExt__CurvedMovement__PathEndY.func(runtimeScene, (( gdjs.evtsExt__Smoothy__CreateLevel.GDGutterObjects3.length === 0 ) ? "" :gdjs.evtsExt__Smoothy__CreateLevel.GDGutterObjects3[0].getBehavior(eventsFunctionContext.getBehaviorName("GutterBehavior")).PathName(eventsFunctionContext)), eventsFunctionContext), "");
}}
...
const repeatCount2 = gdjs.evtTools.variable.getVariableChildCount(runtimeScene.getGame().getVariables().get("Levels").getChild((Number(eventsFunctionContext.getArgument("Level")) || 0)).getChild("Gutters"));
...
if (true)
{
{gdjs.evtTools.object.createObjectOnScene(eventsFunctionContext, gdjs.evtsExt__Smoothy__CreateLevel.mapOfGDgdjs_9546evtsExt_9595_9595Smoothy_9595_9595CreateLevel_9546GDGutterObjects2Objects, gdjs.evtTools.variable.getVariableNumber(runtimeScene.getGame().getVariables().get("Levels").getChild((Number(eventsFunctionContext.getArgument("Level")) || 0)).getChild("Gutters").getChild(gdjs.evtTools.variable.getVariableString(runtimeScene.getScene().getVariables().get("index"))).getChild("StartX")), gdjs.evtTools.variable.getVariableNumber(runtimeScene.getGame().getVariables().get("Levels").getChild((Number(eventsFunctionContext.getArgument("Level")) || 0)).getChild("Gutters").getChild(gdjs.evtTools.variable.getVariableString(runtimeScene.getScene().getVariables().get("index"))).getChild("StartY")), "");
}{gdjs.evtTools.object.createObjectOnScene(eventsFunctionContext, gdjs.evtsExt__Smoothy__CreateLevel.mapOfGDgdjs_9546evtsExt_9595_9595Smoothy_9595_9595CreateLevel_9546GDBubbleQueueObjects2Objects, -(100), -(100), "");
}{for(var i = 0, len = gdjs.evtsExt__Smoothy__CreateLevel.GDGutterObjects2.length ;i < len;++i) {
    gdjs.evtsExt__Smoothy__CreateLevel.GDGutterObjects2[i].getBehavior(eventsFunctionContext.getBehaviorName("ObjectStack")).AddOnTop(gdjs.evtsExt__Smoothy__CreateLevel.mapOfGDgdjs_9546evtsExt_9595_9595Smoothy_9595_9595CreateLevel_9546GDBubbleQueueObjects2Objects, eventsFunctionContext);
}
}{for(var i = 0, len = gdjs.evtsExt__Smoothy__CreateLevel.GDGutterObjects2.length ;i < len;++i) {
    gdjs.evtsExt__Smoothy__CreateLevel.GDGutterObjects2[i].getBehavior(eventsFunctionContext.getBehaviorName("GutterBehavior")).SetPathName("Gutter" + gdjs.evtTools.variable.getVariableString(runtimeScene.getScene().getVariables().get("index")), eventsFunctionContext);
}
}{for(var i = 0, len = gdjs.evtsExt__Smoothy__CreateLevel.GDGutterObjects2.length ;i < len;++i) {
    gdjs.evtsExt__Smoothy__CreateLevel.GDGutterObjects2[i].getBehavior(eventsFunctionContext.getBehaviorName("GutterBehavior")).SetIdentifier(gdjs.evtTools.variable.getVariableNumber(runtimeScene.getScene().getVariables().get("index")), eventsFunctionContext);
}
}{gdjs.evtsExt__CurvedMovement__CreatePathFromSvg.func(runtimeScene, (( gdjs.evtsExt__Smoothy__CreateLevel.GDGutterObjects2.length === 0 ) ? "" :gdjs.evtsExt__Smoothy__CreateLevel.GDGutterObjects2[0].getBehavior(eventsFunctionContext.getBehaviorName("GutterBehavior")).PathName(eventsFunctionContext)), gdjs.evtTools.variable.getVariableString(runtimeScene.getGame().getVariables().get("Levels").getChild((Number(eventsFunctionContext.getArgument("Level")) || 0)).getChild("Gutters").getChild(gdjs.evtTools.variable.getVariableString(runtimeScene.getScene().getVariables().get("index"))).getChild("Path")), eventsFunctionContext);
    ...
    gdjs.evtsExt__Smoothy__CreateLevel.GDSpawnerObjects2[i].getBehavior(eventsFunctionContext.getBehaviorName("SpeedPathMovement")).SetPath((( gdjs.evtsExt__Smoothy__CreateLevel.GDGutterObjects2.length === 0 ) ? "" :gdjs.evtsExt__Smoothy__CreateLevel.GDGutterObjects2[0].getBehavior(eventsFunctionContext.getBehaviorName("GutterBehavior")).PathName(eventsFunctionContext)), 1, false, eventsFunctionContext);
}
}{for(var i = 0, len = gdjs.evtsExt__Smoothy__CreateLevel.GDSpawnerObjects2.length ;i < len;++i) {
