...
gdjs.GameCode.GDBrandingObjects1= [];
gdjs.GameCode.GDBrandingObjects2= [];
gdjs.GameCode.GDBrandingObjects3= [];
gdjs.GameCode.GDBrandingObjects4= [];
gdjs.GameCode.GDBrandingObjects5= [];
gdjs.GameCode.GDBrandingObjects6= [];
gdjs.GameCode.GDBrandingObjects7= [];
gdjs.GameCode.GDBrandingObjects8= [];
...
for (var i = 0, k = 0, l = gdjs.GameCode.GDAimingBubbleObjects3.length;i<l;++i) {
    if ( gdjs.GameCode.GDAimingBubbleObjects3[i].getBehavior("FireBullet").IsReadyToShoot(null) ) {
        isConditionTrue_0 = true;
...
for (var i = 0, k = 0, l = gdjs.GameCode.GDPreviewBubbleObjects3.length;i<l;++i) {
    if ( !(gdjs.GameCode.GDPreviewBubbleObjects3[i].getBehavior("ButtonFSM").IsPressed(null)) ) {
        isConditionTrue_0 = true;
...
{gdjs.evtTools.object.pickAllObjects(runtimeScene, gdjs.GameCode.mapOfGDgdjs_9546GameCode_9546GDPreviewBubbleObjects3Objects);
}{for(var i = 0, len = gdjs.GameCode.GDAimingBubbleObjects3.length ;i < len;++i) {
    gdjs.GameCode.GDAimingBubbleObjects3[i].getBehavior("FireBullet").Fire((gdjs.GameCode.GDAimingBubbleObjects3[i].getPointX("")), (gdjs.GameCode.GDAimingBubbleObjects3[i].getPointY("")), gdjs.GameCode.mapOfGDgdjs_9546GameCode_9546GDMovingBubbleObjects3Objects, gdjs.evtTools.common.angleBetweenPositions((( gdjs.GameCode.GDLauncherObjects3.length === 0 ) ? 0 :gdjs.GameCode.GDLauncherObjects3[0].getPointX("")), (( gdjs.GameCode.GDLauncherObjects3.length === 0 ) ? 0 :gdjs.GameCode.GDLauncherObjects3[0].getPointY("")), gdjs.evtTools.input.getCursorX(runtimeScene, "", 0), gdjs.evtTools.input.getCursorY(runtimeScene, "", 0)), 690, null);
}
}{for(var i = 0, len = gdjs.GameCode.GDMovingBubbleObjects3.length ;i < len;++i) {
    gdjs.GameCode.GDMovingBubbleObjects3[i].getBehavior("Animation").setAnimationName((( gdjs.GameCode.GDAimingBubbleObjects3.length === 0 ) ? "" :gdjs.GameCode.GDAimingBubbleObjects3[0].getAnimationName()));
}
}{for(var i = 0, len = gdjs.GameCode.GDAimingBubbleObjects3.length ;i < len;++i) {
    gdjs.GameCode.GDAimingBubbleObjects3[i].getBehavior("Animation").setAnimationName((( gdjs.GameCode.GDPreviewBubbleObjects3.length === 0 ) ? "" :gdjs.GameCode.GDPreviewBubbleObjects3[0].getAnimationName()));
}
}{for(var i = 0, len = gdjs.GameCode.GDPreviewBubbleObjects3.length ;i < len;++i) {
    gdjs.GameCode.GDPreviewBubbleObjects3[i].getBehavior("Animation").setAnimationName(gdjs.evtTools.variable.getVariableString(runtimeScene.getScene().getVariables().getFromIndex(0).getChild(gdjs.randomInRange(0, (( gdjs.GameCode.GDSpawnerObjects3.length === 0 ) ? 0 :gdjs.GameCode.GDSpawnerObjects3[0].getBehavior("SpwanerBehavior").ColorCount(null)) - 1))));
}
}}
...
gdjs.copyArray(runtimeScene.getObjects("PreviewBubble"), gdjs.GameCode.GDPreviewBubbleObjects3);
for (var i = 0, k = 0, l = gdjs.GameCode.GDPreviewBubbleObjects3.length;i<l;++i) {
    if ( gdjs.GameCode.GDPreviewBubbleObjects3[i].getBehavior("ButtonFSM").IsClicked(null) ) {
...
{gdjs.evtTools.object.pickAllObjects(runtimeScene, gdjs.GameCode.mapOfGDgdjs_9546GameCode_9546GDPreviewBubbleObjects2Objects);
    ...
    gdjs.GameCode.GDPreviewBubbleObjects2[i].getBehavior("Animation").setAnimationName((( gdjs.GameCode.GDAimingBubbleObjects2.length === 0 ) ? "" :gdjs.GameCode.GDAimingBubbleObjects2[0].getAnimationName()));
}
}{for(var i = 0, len = gdjs.GameCode.GDAimingBubbleObjects2.length ;i < len;++i) {
    gdjs.GameCode.GDAimingBubbleObjects2[i].getBehavior("Animation").setAnimationName(gdjs.evtTools.variable.getVariableString(runtimeScene.getScene().getVariables().get("animationName")));
}
}}
...
let isConditionTrue_0 = false;
isConditionTrue_0 = false;
isConditionTrue_0 = gdjs.evtsExt__ObjectStack__Contains.func(runtimeScene, gdjs.GameCode.mapOfGDgdjs_9546GameCode_9546GDBubbleQueueObjects3Objects, "ObjectStack", gdjs.GameCode.mapOfGDgdjs_9546GameCode_9546GDBoardBubbleObjects3Objects, null);
if (isConditionTrue_0) {
isConditionTrue_0 = false;
isConditionTrue_0 = gdjs.evtsExt__ObjectStack__Contains.func(runtimeScene, gdjs.GameCode.mapOfGDgdjs_9546GameCode_9546GDGutterObjects3Objects, "ObjectStack", gdjs.GameCode.mapOfGDgdjs_9546GameCode_9546GDBubbleQueueObjects3Objects, null);
}
if (isConditionTrue_0) {
/* Reuse gdjs.GameCode.GDBoardBubbleObjects3 */
/* Reuse gdjs.GameCode.GDBubbleQueueObjects3 */
...
{gdjs.evtTools.object.createObjectOnScene(runtimeScene, gdjs.GameCode.mapOfGDgdjs_9546GameCode_9546GDInsertedBubbleObjects3Objects, (( gdjs.GameCode.GDGutterObjects3.length === 0 ) ? 0 :gdjs.GameCode.GDGutterObjects3[0].getPointX("")), (( gdjs.GameCode.GDGutterObjects3.length === 0 ) ? 0 :gdjs.GameCode.GDGutterObjects3[0].getPointY("")), "");
...
for (var i = 0, k = 0, l = gdjs.GameCode.GDGutterObjects2.length;i<l;++i) {
    if ( gdjs.GameCode.GDGutterObjects2[i].getBehavior("GutterBehavior").Identifier(null) == (( gdjs.GameCode.GDInsertedBubbleObjects2.length === 0 ) ? 0 :gdjs.GameCode.GDInsertedBubbleObjects2[0].getBehavior("InsertedBubble").GutterIdentifier(null)) ) {
        isConditionTrue_0 = true;
...
{runtimeScene.getScene().getVariables().get("Score").add(10 * gdjs.evtTools.object.getPickedInstancesCount(gdjs.GameCode.mapOfGDgdjs_9546GameCode_9546GDBoardBubbleObjects2Objects));
    ...
    gdjs.GameCode.GDBoardBubbleObjects2[i].getBehavior("BoardBubbleBehavior").Explode(gdjs.GameCode.mapOfGDgdjs_9546GameCode_9546GDBubbleExplosionObjects2Objects, null);
}
}}
...
if (isConditionTrue_0) {
isConditionTrue_0 = false;
isConditionTrue_0 = gdjs.evtTools.object.pickRandomObject(runtimeScene, gdjs.GameCode.mapOfGDgdjs_9546GameCode_9546GDBoardBubbleObjects3Objects);
}
if (isConditionTrue_0) {
...
for (var i = 0, k = 0, l = gdjs.GameCode.GDInsertedBubbleObjects3.length;i<l;++i) {
    if ( !(gdjs.GameCode.GDInsertedBubbleObjects3[i].getBehavior("InsertedBubble").IsAnimationFinished(null)) ) {
        isConditionTrue_0 = true;
...
for (var i = 0, k = 0, l = gdjs.GameCode.GDInsertedBubbleObjects2.length;i<l;++i) {
    if ( gdjs.GameCode.GDInsertedBubbleObjects2[i].getBehavior("InsertedBubble").IsAnimationFinished(null) ) {
        isConditionTrue_0 = true;
...
{for(var i = 0, len = gdjs.GameCode.GDInsertedBubbleObjects2.length ;i < len;++i) {
    gdjs.GameCode.GDInsertedBubbleObjects2[i].getBehavior("InsertedBubble").CreateBubble(gdjs.GameCode.mapOfGDgdjs_9546GameCode_9546GDGutterObjects2Objects, "GutterBehavior", "ObjectStack", gdjs.GameCode.mapOfGDgdjs_9546GameCode_9546GDBubbleQueueObjects2Objects, "ObjectStack", gdjs.GameCode.mapOfGDgdjs_9546GameCode_9546GDBoardBubbleObjects2Objects, "SpeedPathMovement", null);
}
}
{ //Subevents
...
}{runtimeScene.getScene().getVariables().get("Score").add(100 * (( gdjs.GameCode.GDBubbleQueueObjects7.length === 0 ) ? 0 :gdjs.GameCode.GDBubbleQueueObjects7[0].getBehavior("BubbleQueueBehavior").HeadComboLevel(null)));
}{for(var i = 0, len = gdjs.GameCode.GDBoardBubbleObjects7.length ;i < len;++i) {
    gdjs.GameCode.GDBoardBubbleObjects7[i].getBehavior("BoardBubbleBehavior").Explode(gdjs.GameCode.mapOfGDgdjs_9546GameCode_9546GDBubbleExplosionObjects7Objects, null);
}
}}
...
let isConditionTrue_0 = false;
if (true) {
{runtimeScene.getScene().getVariables().get("queueIndex").setNumber((( gdjs.GameCode.GDGutterObjects3.length === 0 ) ? 0 :gdjs.GameCode.GDGutterObjects3[0].getBehavior("ObjectStack").Height(null)) - 1);
}
{ //Subevents: 
...
{for(var i = 0, len = gdjs.GameCode.GDGutterObjects2.length ;i < len;++i) {
    gdjs.GameCode.GDGutterObjects2[i].getBehavior("GutterBehavior").UpdateMatchingQueue(gdjs.GameCode.mapOfGDgdjs_9546GameCode_9546GDBubbleQueueObjects2Objects, "BubbleQueueBehavior", "ObjectStack", gdjs.GameCode.mapOfGDgdjs_9546GameCode_9546GDBoardBubbleObjects2Objects, "BoardBubbleBehavior", "SpeedPathMovement", null);
}
}}
...
gdjs.copyArray(runtimeScene.getObjects("Gutter"), gdjs.GameCode.GDGutterObjects2);
{for(var i = 0, len = gdjs.GameCode.GDGutterObjects2.length ;i < len;++i) {
    gdjs.GameCode.GDGutterObjects2[i].getBehavior("GutterBehavior").UpdateFirstHeadPosition(gdjs.GameCode.mapOfGDgdjs_9546GameCode_9546GDBubbleQueueObjects2Objects, "ObjectStack", gdjs.GameCode.mapOfGDgdjs_9546GameCode_9546GDBoardBubbleObjects2Objects, "SpeedPathMovement", null);
}
}{for(var i = 0, len = gdjs.GameCode.GDBubbleQueueObjects2.length ;i < len;++i) {
    gdjs.GameCode.GDBubbleQueueObjects2[i].getBehavior("BubbleQueueBehavior").SetBubblesSpeed(gdjs.GameCode.mapOfGDgdjs_9546GameCode_9546GDGutterObjects2Objects, "GutterBehavior", "ObjectStack", gdjs.GameCode.mapOfGDgdjs_9546GameCode_9546GDBoardBubbleObjects2Objects, "SpeedPathMovement", null);
}
}}
...
{for(var i = 0, len = gdjs.GameCode.GDScoreObjects2.length ;i < len;++i) {
    gdjs.GameCode.GDScoreObjects2[i].getBehavior("Text").setText(gdjs.evtTools.variable.getVariableString(runtimeScene.getScene().getVariables().get("Score")));
}
    ...
    gdjs.GameCode.GDCountdownObjects2[i].getBehavior("Text").setText(gdjs.evtsExt__TimeFormatter__SecondsToHHMMSS.func(runtimeScene, gdjs.evtTools.variable.getVariableNumber(runtimeScene.getScene().getVariables().get("Countdown")), null));
}
}}
...
gdjs.copyArray(runtimeScene.getObjects("Gutter"), gdjs.GameCode.GDGutterObjects2);
for (var i = 0, k = 0, l = gdjs.GameCode.GDGutterObjects2.length;i<l;++i) {
    if ( gdjs.GameCode.GDGutterObjects2[i].getBehavior("GutterBehavior").IsAnyBubbleReachHole(gdjs.GameCode.mapOfGDgdjs_9546GameCode_9546GDBubbleQueueObjects2Objects, "ObjectStack", gdjs.GameCode.mapOfGDgdjs_9546GameCode_9546GDBoardBubbleObjects2Objects, "SpeedPathMovement", null) ) {
        isConditionTrue_1 = true;
        gdjs.GameCode.GDGutterObjects2[k] = gdjs.GameCode.GDGutterObjects2[i];
        ++k;
    }
...
gdjs.GameCode.asyncCallback12642580 = function (runtimeScene, asyncObjectsList) {
...
runtimeScene.getAsyncTasksManager().addTask(gdjs.evtTools.runtimeScene.wait(0.5), (runtimeScene) => (gdjs.GameCode.asyncCallback12642580(runtimeScene, asyncObjectsList)));
}
}
...
for (var i = 0, k = 0, l = gdjs.GameCode.GDBoardBubbleObjects2.length;i<l;++i) {
    if ( gdjs.GameCode.GDBoardBubbleObjects2[i].getBehavior("SpeedPathMovement").HasReachedTarget(null) ) {
        isConditionTrue_0 = true;
...
let isConditionTrue_0 = false;
isConditionTrue_0 = false;
isConditionTrue_0 = gdjs.evtsExt__ObjectStack__HasOnTop.func(runtimeScene, gdjs.GameCode.mapOfGDgdjs_9546GameCode_9546GDGutterObjects1Objects, "ObjectStack", gdjs.GameCode.mapOfGDgdjs_9546GameCode_9546GDBubbleQueueObjects1Objects, null);
if (isConditionTrue_0) {
isConditionTrue_0 = false;
isConditionTrue_0 = gdjs.evtsExt__ObjectStack__HasOnTop.func(runtimeScene, gdjs.GameCode.mapOfGDgdjs_9546GameCode_9546GDBubbleQueueObjects1Objects, "ObjectStack", gdjs.GameCode.mapOfGDgdjs_9546GameCode_9546GDBoardBubbleObjects1Objects, null);
if (isConditionTrue_0) {
isConditionTrue_0 = false;
for (var i = 0, k = 0, l = gdjs.GameCode.GDBoardBubbleObjects1.length;i<l;++i) {
    if ( gdjs.GameCode.GDBoardBubbleObjects1[i].getBehavior("SpeedPathMovement").HasReachedAnEnd(null) ) {
        isConditionTrue_0 = true;
...
{for(var i = 0, len = gdjs.GameCode.GDBoardBubbleObjects1.length ;i < len;++i) {
    gdjs.GameCode.GDBoardBubbleObjects1[i].getBehavior("SpeedPathMovement").AccelarateAt(2000, 2000, null);
}
...
gdjs.GameCode.GDBrandingObjects1.length = 0;
gdjs.GameCode.GDBrandingObjects2.length = 0;
gdjs.GameCode.GDBrandingObjects3.length = 0;
gdjs.GameCode.GDBrandingObjects4.length = 0;
gdjs.GameCode.GDBrandingObjects5.length = 0;
gdjs.GameCode.GDBrandingObjects6.length = 0;
gdjs.GameCode.GDBrandingObjects7.length = 0;
gdjs.GameCode.GDBrandingObjects8.length = 0;
